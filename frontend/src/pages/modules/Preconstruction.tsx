// ============================================================
// OC PIPELINE - PRECONSTRUCTION MODULE
// Full-featured module with Overview Dashboard, Pursuits, Estimates, Bid Packages
// ============================================================
...
import { SamGovImport } from '@/components/sam-gov';
import { PursuitsTable } from '@/components/pursuits';
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <SamGovImport onImportComplete={onRefresh} />
                  ...
                  <TableRow key={estimate.id}>
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem onClick={() => setSelectedEstimateId(estimate.id)}>
                            <Eye className="w-4 h-4 mr-2" />
                            View Details
                          </DropdownMenuItem>
                          <DropdownMenuItem onClick={() => setSelectedEstimateId(estimate.id)}>
    ...
    <div className="max-w-full">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="mb-4">
          ...
          <TabsTrigger value="ai-estimating" className="flex items-center gap-2">
            <Bot className="w-4 h-4" />
            AI Estimating
          </TabsTrigger>
        </TabsList>

        {/* Overview Tab - 2026 Estimating Command Dashboard */}
        ...
        <TabsContent value="ai-estimating">
          <AIEstimatingForm />
        </TabsContent>
      </Tabs>
    </div>
