...
// Agentic Module Routes
import agenticRoutes from "./routes/agentic";

// AI Risk Agent Routes (new)
import riskAgentRoutes from "./routes/riskAgentRoutes";

// Cost Codes Module Routes
import costCodesRoutes from "./routes/cost-codes.routes";
...
// AI Risk Agent Routes (new)
app.use("/api/ai", riskAgentRoutes);
...
app.listen(PORT, () => {
  ...
  console.log(
    "✅ Admin Module: Loaded (users, roles, permissions, organizations, settings, audit)"
  );
  console.log(
    "✅ Agentic Module: Loaded (agents, tasks, messages, coordination, events, knowledge-graph)"
  );
  console.log(
    "✅ Cost Codes Module: Loaded (CSI MasterFormat, Uniformat II, custom)"
  );
  console.log("✅ AI Risk Agent: Loaded (/api/ai/risk-agent)");
